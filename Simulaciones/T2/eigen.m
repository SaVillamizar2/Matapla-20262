...
for i = 3:5
    ...
    disp(Eval{i});
    disp(['Eigenvectors for matrix K(' num2str(i) '):']);
    disp(Evec{i});
end


N = 1; % Dimensión del sistema (puedes cambiarlo a 4, 5, etc.)
...
[Auto_Vec, Auto_Val] = eig(M4,"vector");
...
for modo = 1:2
    ...
    title(['Modo de Vibración ' num2str(modo) ' (N = ' num2str(N) ')']);
